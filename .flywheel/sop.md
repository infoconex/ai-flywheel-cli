...
4. Classify defects, findings, decisions, and learning.
5. Adapt code, framework integration, or this procedure only when justified.
6. Validate deterministically with local build and tests where possible.
7. Persist evidence and durable knowledge.
8. Reuse validated learning in later work.
...
Do not hide failed attempts. Record the failure, classification, adaptation, and resulting validation.
